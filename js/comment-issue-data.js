...
var repoIssuesUrl = "https://api.github.com/repos/haojie06/haojie06.github.io/issues";
// 对应仓库 clientId、clientSecret 关于这两个参数的安全问题，查看 https://removeif.github.io/2019/09/19/博客源码分享.html#1-热门推荐，最新评论：
var clientId = "bb213e21b5713e14658b";
var clientSecret = "4bcff02ab087dfe727233e13e837ba26abe6088f";
    ...
    if ($("#index_hot_div").length > 0) {
        ...
        ajaxReqForGitHub(repoIssuesUrl + "?per_page=10&sort=comments", authorizationToken, function (result) {
            ...
            $.each(result, function (i, item) {
                ...
                hotContent += "<a href =\"" + item.body.substr(0, item.body.indexOf("\n") - 1) + "\"target=\"_blank\"" + classDiv + ">" + item.title.substr(0, item.title.indexOf("-") - 1) + "&nbsp;🔥" + (item.comments * 10) + "</a>&nbsp;&nbsp;"
            })
            hotDiv.html("");
            if (hotContent == "") {
                hotDiv.append("无数据记录！");
